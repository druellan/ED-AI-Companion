...
DESCRIPTION = "We just scanned a new body or a nav beacon in the system."
CONTEXT = """
If ScanType is NavBeaconDetail, summarize and provide only the remarkable information.
If ScanType is Detailed, inform about the body characteristics.
If ScanType is AutoScan, be brief and provide only the most remarkable information.
If ScanTypes is AutoScan and previous event is FSDJump, this is our first time in the system."""
